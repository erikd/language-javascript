...
testProgramParser = describe "Minify programs:" $ do
    it "function" $ do
    ...
    it "regex" $ do
        ...
        testProg "x=i(/^$/g,\"\\\\$&\")" `shouldBe` "Right (JSAstProgram [JSOpAssign ('=',JSIdentifier 'x',JSMemberExpression (JSIdentifier 'i',JSArguments (JSRegEx '/^$/g',JSStringLiteralD '\\\\$&')))])"
        testProg "x=i(/[?|^&(){}\\[\\]+\\-*\\/\\.]/g,\"\\\\$&\")" `shouldBe` "Right (JSAstProgram [JSOpAssign ('=',JSIdentifier 'x',JSMemberExpression (JSIdentifier 'i',JSArguments (JSRegEx '/[?|^&(){}\\[\\]+\\-*\\/\\.]/g',JSStringLiteralD '\\\\$&')))])"
    ...
    it "unicode" $ do
        ...
        testProg "x=\"àáâãäå\";y='\3012a\0068'" `shouldBe` "Right (JSAstProgram [JSOpAssign ('=',JSIdentifier 'x',JSStringLiteralD '\224\225\226\227\228\229'),JSSemicolon,JSOpAssign ('=',JSIdentifier 'y',JSStringLiteralS '\3012aD')])"
    ...
    it "strings" $ do
        ...
        testProg "x='abc\\\ndef';"       `shouldBe` "Right (JSAstProgram [JSOpAssign ('=',JSIdentifier 'x',JSStringLiteralS 'abc\\\ndef'),JSSemicolon])"
        testProg "x=\"abc\\\ndef\";"     `shouldBe` "Right (JSAstProgram [JSOpAssign ('=',JSIdentifier 'x',JSStringLiteralD 'abc\\\ndef'),JSSemicolon])"
        testProg "x=\"abc\\\rdef\";"     `shouldBe` "Right (JSAstProgram [JSOpAssign ('=',JSIdentifier 'x',JSStringLiteralD 'abc\\\rdef'),JSSemicolon])"
        testProg "x=\"abc\\\r\ndef\";"   `shouldBe` "Right (JSAstProgram [JSOpAssign ('=',JSIdentifier 'x',JSStringLiteralD 'abc\\\r\ndef'),JSSemicolon])"
        testProg "x=\"abc\\\x2028 def\";"    `shouldBe` "Right (JSAstProgram [JSOpAssign ('=',JSIdentifier 'x',JSStringLiteralD 'abc\\\8232 def'),JSSemicolon])"
        testProg "x=\"abc\\\x2029 def\";"    `shouldBe` "Right (JSAstProgram [JSOpAssign ('=',JSIdentifier 'x',JSStringLiteralD 'abc\\\8233 def'),JSSemicolon])"
