...
StatementNoEmpty : StatementBlock      { $1 {- 'StatementNoEmpty1' -} }
                 ...
                 | ImportStatement     { $1 {- 'StatementNoEmpty15' -} }
                 | ExportStatement     { $1 {- 'StatementNoEmpty16' -} }
                 | DebuggerStatement   { $1 {- 'StatementNoEmpty17' -} }
...
-- ImportStatement :                                                          See clause 15
--       import Expression from LiteralString
--       import LiteralString
ImportStatement :: { AST.JSStatement }
ImportStatement : Import Literal MaybeSemi
                   { AST.JSImport $1 Nothing AST.JSNoAnnot $2 $3 {- 'ImportFile' -} }
                | Import StatementNoEmpty From Literal MaybeSemi
                   { AST.JSImport $1 (Just $2) $3 $4 $5 {- 'ImportNamesFromFile' -} }

-- ExportStatement :
--       export Expression
ExportStatement :: { AST.JSStatement }
ExportStatement : Export StatementNoEmpty MaybeSemi { AST.JSExport $1 Nothing $2 $3 }
                | Export Default StatementNoEmpty MaybeSemi { AST.JSExport $1 (Just $2) $3 $4 }
