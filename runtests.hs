...
testSuite = testGroup "Parser"
   ...
   , testCase "loc1" (testProgUn "x = 1\n  y=2;" "Right (NS (JSSourceElementsTop [NS (JSExpression [NS (JSIdentifier \"x\") (TokenPn 0 1 1) [],NS (JSOperator \"=\") (TokenPn 2 1 3) [],NS (JSDecimal \"1\") (TokenPn 4 1 5) []]) (TokenPn 0 1 1) [],NS (JSExpression [NS (JSIdentifier \"y\") (TokenPn 8 2 3) [],NS (JSOperator \"=\") (TokenPn 9 2 4) [],NS (JSDecimal \"2\") (TokenPn 10 2 5) []]) (TokenPn 8 2 3) [],NS (JSLiteral \";\") (TokenPn 11 2 6) []]) (TokenPn 0 1 1) [])")
