...
testSuite = testGroup "Parser"
    ...
    , testCase "Var2" (testStmt "const x=1,y=2;"    "Right (JSAstStatement (JSConstant (JSVarInitExpression (JSIdentifier 'x') [JSDecimal '1'],JSVarInitExpression (JSIdentifier 'y') [JSDecimal '2'])))")
